// Metodi con cui interagiamo con il database FirebaseFirestore
...
class UserRepository {
  ...
  UserRepository({required this.firebaseFirestore, required this.userMapper});
  ...
  Stream<User> user(String uid) => firebaseFirestore
      ...
      .asyncMap((userStream) => userMapper.fromFirebase(userStream.data() ?? {}));

  Future<void> create(User user) async => await firebaseFirestore.collection('users')
      .doc(user.id) // TODO id
