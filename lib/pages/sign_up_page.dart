        ...
        BlocConsumer<SignUpBloc, SignUpState>(
          builder: (context, state) =>
            ...
            listener: (context, state) {
              _shouldCloseForSignUp(context, state: state);
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: AppLocalizations
                    .of(context)
                    ?.label_last_name ?? '',
                errorText: error?.localizedString(
                    context),
              ),
              keyboardType: TextInputType.name,
            ),
  ...
  Widget _emailField(BuildContext context, {bool enabled = true}) =>
      TwoWayBindingBuilder<String>(
        ...
        builder: (context, controller, data, onChanged, error) =>
            TextField(
              enabled: enabled,
              controller: controller, // Bindiamo il controller
              onChanged: onChanged,
              decoration: InputDecoration(
      ...
      TwoWayBindingBuilder<String>(
        ...
        builder: (context, controller, data, onChanged, error) =>
            TextField(
              ...
              onChanged: onChanged,
              decoration: InputDecoration(
                hintText: AppLocalizations.of(context)?.label_password_confirm ?? '',
                errorText: error?.localizedString(context),
              ),
              obscureText: true,
            ),
      ...
      WidgetsBinding.instance!.addPostFrameCallback((timestamp) {
        if (state is ErrorSignUpState) {
          showDialog(
            ...
            builder: (context) =>
                AlertDialog(
                  title: Text(AppLocalizations.of(context)?.dialog_wrong_sign_up_title ?? ''),
                  content: Text(AppLocalizations.of(context)?.dialog_wrong_sign_up_message ?? ''),
                  actions: [
                    TextButton(
                      onPressed: () {},
